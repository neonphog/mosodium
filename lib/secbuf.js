...
class SecBuf {
   ...
   */
  randomize () {
    this._protect && sodium.sodium_mprotect_readwrite(this._)
    sodium.randombytes_buf(this._)
    this._protect && sodium.sodium_mprotect_noaccess(this._)
  }
   ...
   */
  readable (fn) {
    this._protect && sodium.sodium_mprotect_readonly(this._)
    try {
      fn(this._)
      this._protect && sodium.sodium_mprotect_noaccess(this._)
    } catch (e) {
